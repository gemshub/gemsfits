...
qtfontsdir=$HOME/Qt/5.5/Src/qtbase/lib/fonts
...
qtplatformplugin=$HOME/Qt/5.5/gcc_64/plugins/platforms/libqxcb.so
...
# requires.
qtsqliteplugin=$HOME/Qt/5.5/gcc_64/plugins/sqldrivers/libqsqlite.so
...
qtqcollectiongenerator=$HOME/Qt/5.5/gcc_64/bin/qcollectiongenerator
cp $qtqcollectiongenerator $tardir
echo "Copied executable "$qtqcollectiongenerator" to "$tardir
qtqhelpgenerator=$HOME/Qt/5.5/gcc_64/bin/qhelpgenerator
