...
cp $HOME/Qt/5.11.0/gcc_64/plugins/platforms/libqxcb.so $qtplatformplugindir
cp $HOME/Qt/5.11.0/gcc_64/lib/libQt5XcbQpa.so.5 $libsdir
cp $HOME/Qt/5.11.0/gcc_64/lib/libQt5DBus.so.5 $libsdir
