...
qtfontsdir=$HOME/Qt/5.15.2/Src/qtbase/lib/fonts
...
qtplatformplugin=$HOME/Qt/5.15.2/gcc_64/plugins/platforms/libqxcb.so
...
cp $HOME/Qt/5.15.2/gcc_64/plugins/platforms/libqxcb.so $qtplatformplugindir
cp $HOME/Qt/5.15.2/gcc_64/lib/libQt5XcbQpa.so.5 $libsdir
cp $HOME/Qt/5.15.2/gcc_64/lib/libQt5DBus.so.5 $libsdir
...
# requires.
qtsqliteplugin=$HOME/Qt/5.15.2/gcc_64/plugins/sqldrivers/libqsqlite.so
...
qtqcollectiongenerator=$HOME/Qt/5.15.2/gcc_64/bin/qcollectiongenerator
cp $qtqcollectiongenerator $tardir
echo "Copied executable "$qtqcollectiongenerator" to "$tardir
qtqhelpgenerator=$HOME/Qt/5.15.2/gcc_64/bin/qhelpgenerator
