...
INSERT INTO public.experiments (temperature, pressure, reference) 
	SELECT t_c, p_bar, expsetid FROM impdata.expcsd;
...
UPDATE impdata.temp1 SET quantity = 1000*temp2.quantity 
...
UPDATE impdata.temp1 SET quantity = 60.0843*temp2.quantity 
	FROM impdata.temp2 WHERE temp1.id=temp2.id;
UPDATE impdata.temp1 SET id_comp = 
...
UPDATE impdata.temp1 SET quantity = 74.09268*temp2.quantity 
	FROM impdata.temp2 WHERE temp1.id=temp2.id;
UPDATE impdata.temp1 SET id_comp = 
...
UPDATE impdata.temp1 SET quantity = 78.0035586*temp2.quantity 
	FROM impdata.temp2 WHERE temp1.id=temp2.id;
UPDATE impdata.temp1 SET id_comp = 
...
UPDATE impdata.temp1 SET quantity = 39.99710928*temp2.quantity 
	FROM impdata.temp2 WHERE temp1.id=temp2.id;
UPDATE impdata.temp1 SET id_comp = 
...
UPDATE impdata.temp1 SET quantity = 56.10564*temp2.quantity 
	FROM impdata.temp2 WHERE temp1.id=temp2.id;
UPDATE impdata.temp1 SET id_comp = 
...
UPDATE impdata.temp1 SET quantity = 44.0095*temp2.quantity 
	FROM impdata.temp2 WHERE temp1.id=temp2.id;
UPDATE impdata.temp1 SET id_comp = 
...
DELETE FROM public.exp_comp WHERE quantity IS NULL; 
