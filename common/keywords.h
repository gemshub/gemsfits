...
static const char *AddOptParameters[2] = {"AdditionalParametersToOptimize",      "AddParToOpt"};
...
static const char *OptPrec[2]      = {"ValuePrecision",        "ValPrec"};
...
static const char *molkg            = "mol/kg"; //                           string          mole  per kg phase
static const char *molkg_dry        = "mol/kg(dry)"; //                      string          mole  per kg dry phase
static const char *logmolkg         = "log(mol/kg)"; //                      string          mole  per kg phase
static const char *logmolkg_dry     = "log(mol/kg)(dry)"; //                 string          mole  per kg dry phase
static const char *Lkg              = "L/kg"; //                             string          liter per kg phase
static const char *Lkg_dry          = "L/kg(dry)"; //                        string          liter per kg dry phase
