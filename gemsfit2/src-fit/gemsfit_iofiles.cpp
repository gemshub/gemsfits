...
//      "\n#    \'all\': select all data"
      ...
      "\n#       Any main selection option can be left out."
      ...
      "\n#      \"uesamples\": [...]: list of comma-separated names of samples, "
      ...
      "\n#      \"usepairs\": [...]: JSON objects of dataset-samples pairs to be used (sub-option to the ones above), "
      "\n#         or empty string \"\" for the above selection options to apply."
      "\n#          \"usedataset\": \" \" name of the dataset "
      "\n#          \"usesamples\": [...]: list of comma-separated names of samples to be used "
      "\n#      \"skippairs\": [...]: JSON objects of dataset-samples pairs to be skipped (sub-option to the ones above), "
      "\n#         or empty string \"\" for the above selection options to apply."
      "\n#          \"usedataset\": \" \" name of the dataset "
      "\n#          \"usesamples\": [...]: list of comma-separated names of samples to be used "
      ...
      "\n#        \"usepairs\" : \"\", "
      "\n#        \"skippairs\" : [ "
      "\n#                          { \"skipdataset\": \"CHO4\", \"skipsamples\": [\"01\", \"02\"]}, "
      "\n#                          { \"skipdataset\": \"CHO4D\", \"skipsamples\": [\"01\", \"02\"]}, "
      "\n#                        ], "
      "\n#        \"sT\" : [100, 1000],"
      "\n#        \"sP\" : [1, 2500] }\'"
    ...
    { "DataTarget",  0, 0, 1, "# DataTarget: Target function for parameter fitting, described in JSON style"
      ...
      "\n#        IMPORTANT: When \"NFUN\" (nested function) is present in DataSelect it is necessary that at least one \"Ptype\" paramater "
      "\n#                   is marked for fitting. One can have multiple NFUN each with its parameter type (\"Ptype\"). "
      "\n#"
