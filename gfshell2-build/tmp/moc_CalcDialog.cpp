...
#include "../../gfshell2/dialogs/CalcDialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CalcDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 41, 9)
    ...
    "CalcDialog\0languageChange\0\0setMode\0"
    "id\0ok\0unaryMode"
};
...
const QMetaObject CalcDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CalcDialog.data,
      qt_meta_data_CalcDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CalcDialog.stringdata))
        return static_cast<void*>(const_cast< CalcDialog*>(this));
    if (!strcmp(_clname, "Ui::CalcDialogData"))
        return static_cast< Ui::CalcDialogData*>(const_cast< CalcDialog*>(this));
